            ...
            <ApparateContextProvider>
                <ChartContextProvider>
                    ...
                    <div className={styles.buttonsPagination}>
                        <button onClick={() => setSelectedComponent('WEIGHT')}>{t("model.strainGauge")}</button>
                        <button onClick={() => setSelectedComponent('THERMOSENSOR')}>{t("model.thermoSensor")}</button>
                        <button onClick={() => setSelectedComponent('PHOTORESISTOR')}>{t("model.photoresistor")}</button>
                    </div>
